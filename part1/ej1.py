...
import ej1_wform as wform  # embedded python module
import math
...
class ej1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.tabla_de_verdad_constelacion = tabla_de_verdad_constelacion = digital.constellation_16qam().points()
        self.M = M = len(tabla_de_verdad_constelacion )
        self.ntaps = ntaps = 256
        self.bps = bps = int(math.log(M,2))
        self.Sps = Sps = 8
        self.Rs = Rs = 32000
        self.samp_rate = samp_rate = Rs*Sps
        self.h = h = wform.nyq(Sps,ntaps)
        self.Rb = Rb = Rs*bps
        ...
        self.top_grid_layout.addWidget(self.menu, 0, 4, 1, 1)
        for r in range(0, 1):
        ...
        self.analog_noise_source_x_0 = analog.noise_source_c(analog.GR_GAUSSIAN, 0.2*0, 0)
    ...
    def set_ntaps(self, ntaps):
        self.ntaps = ntaps
        self.set_h(wform.nyq(self.Sps,self.ntaps))
